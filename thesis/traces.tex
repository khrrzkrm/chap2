...
\begin{tikzpicture}[
    ...
    \node[right, black, font=\footnotesize, align=left] at (8.5, -1.25)
        {\textbf{Synchronous Padding} $\ST$\\
         Aligns events to clock ticks\\
         Inserts `$(-)$' when an event \\is missing at time $t$};

    \node[right, black, font=\footnotesize, align=left] at (8.5, -3.75)
...
\begin{table}[h!]
  ...
  Metric-Time & $\taumt$ & $(\Sigma \times \mathbb{N})^*$ & Precise timestamps; quantitative timing. \\
