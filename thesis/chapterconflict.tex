...
In this chapter, we provide a logical framework for \emph{metric-time normative conflicts} that deals with these issues in a mathematically precise manner. Our specific contributions, building up on our previous work \cite{kharraz2021timed,DBLP:conf/jurix/KharrazSL24} are as follows:
