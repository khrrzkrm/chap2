...
Such a rich syntax would enable the specification of complex requirements, such as an obligation for ``Agent 1 must accomplish action $\acta$ within 5 time units without interference from agent 2.''
