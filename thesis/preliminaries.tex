...
\]
where \(\size{\is}:= \sum_{I \in \is} \size{I}\) is the sum of the sizes  of the intervals in \(\is\), and \(\card(\is)\) is the cardinality of \(\is\), i.e., the number of intervals syntactically forming \(\is\).
\end{definition}
