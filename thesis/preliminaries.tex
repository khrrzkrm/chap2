...
\begin{enumerate}
    ...
    \item Let $I_2:=[8, 24]$ represent the constraint between 8:00 and 24.
...
\end{example}
 ...
 \subsubsection{Union}
The union of two interval sets $\is$ and $\is'$ is recxursively computed by the successive union of each interval $I_i \in \is'$ with $\is$:
\[
