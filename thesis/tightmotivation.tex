...
\begin{figure}[h]
  ...
  \begin{tikzpicture}[
      ...
      % Arrows
      \draw[->, ultra thick, gray, dashed] (pre) -- (eal) node[midway, sloped, above, font=\scriptsize, text=black] {  $x \in\Sigma^+$};
      \draw[->, ultra thick, gray,dashed] (pre) -- (erl) node[midway, sloped, below, font=\scriptsize, text=black] {$x' \in \Sigma^+$};
      \draw[->, ultra thick, gray] (eal) -- (ial) node[midway, sloped, below, font=\scriptsize, text=black] {$\Sigma^+$};
      \draw[->, ultra thick, gray] (erl) -- (irl) node[midway, sloped, below, font=\scriptsize, text=black] {$\Sigma^+$};
