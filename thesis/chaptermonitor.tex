...
\end{example}
  ...
  The individual Moore machines underlying the product construction are recalled in Sub-figure~\ref{fig:moore-tenant-prod} and Sub-figure~\ref{fig:moore-landlord-prod}, while their synchronous product is summarized in Sub-figure~\ref{fig:product-sketch} and presented as a whole in \ref{fig:moore-product-full}.
  \begin{figure}[h]
  \centering
  \begin{subfigure}[t]{0.70\textwidth}
  \centering
  ...
  \noindent
  Concretely, The run of the product $M_1^1 \times M_2^1$ in  Sub-figure~\ref{fig:product-sketch}, corresponds to the omega-word\\
 ...
 Let $a \in \Sigma_C$ denote a collaborative action, $A \in 2^{\Gamma}$ a party-tagged action set, and $n \in \mathbb{N}^*$ a non-zero natural number.
  ...
  \emph{n-repitition} clauses inforces the repition of the enforcement of a contract $n$ times, with $n \in \mathbb{N^*}$; and finally, \emph{repetition} \(\repit{C}\) for the infinite repetition of the enforcement of a contract.
