...
While a rich family of specification languages for contracts exists, including \cite{HvitvedKZ12,azzopardi2021,diaz2013specification,governatori2005representing}, these formalisms do not fully capture the nuances of assigning duties and rights to agents and timing settings. Rather than introducing an entirely new formalism from scratch, we build upon the framework of \cite{Azzopardi2016,Kharraz23}. We selected this frameworks as the most suitable operational baseline and extended it to address these specific gaps.
