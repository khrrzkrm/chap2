...
To avoid conflicts, only combinations with pairwise distinct times remain, i.e.\ $4\!\cdot\!3\!\cdot\!2=24$ product terms—a substantial disjunction.
...
Although this worst case is large, conflict-free formulas often admit concise equivalents by \emph{merging} punctual literals over the same action.  
