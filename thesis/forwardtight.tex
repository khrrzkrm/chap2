...
Coherence requires that, for any fixed contract and trace, the semantics conclude a unique verdict out of the five possible ones. It also extends to prefix properties: for instance, a prefix that tightly satisfies a contract cannot have a sub-prefix that violates it, and vice versa. The main focus lies on establishing the disjointness of tight satisfaction and tight violation, which is then extended to the semantic definitions of the other three verdicts. The next lemma establishes this result, proving both point-wise disjointness and cross-prefix exclusion in a single pass.
